...
// Write uses lto_begin_section/lto_write_data with section name
// ".gnu.lto_.array_detect.<id>" in LGEN, and ".gnu.lto_.array_detect" in WPA.
// Read is handled by plugin-top via section_hash_table + manual file reads.
